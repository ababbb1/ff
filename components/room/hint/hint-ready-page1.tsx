export default function HintReadyPage1() {
  return (
    <div className="w-full h-full flex">
      <div className="h-full w-[35%] border-r border-black flex flex-col px-10">
        <div className="w-full h-2/3 border-b-2 border-black flex justify-center items-center px-8">
          <div className="w-full aspect-square border-2 border-black rounded-lg"></div>
        </div>
        <div className="w-full h-[38%] flex flex-col px-16 pt-8 gap-2 2xl:gap-3">
          <span className="font-semibold text-xl 2xl:text-2xl">
            장세민 (피해자)
          </span>
          <span className="2xl:text-xl">성별 - 남성</span>
          <span className="2xl:text-xl">나이 - 70세</span>
          <span className="2xl:text-xl">직업 - 추리소설 작가</span>
        </div>
      </div>
      ...
      <div className="h-full w-[14%] pt-10 flex justify-center">
        <span className="font-bold text-7xl 2xl:text-8xl">01</span>
      </div>
    </div>
  );
}
